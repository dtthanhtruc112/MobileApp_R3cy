...
public class Faqs_giaohang_Fragment extends Fragment {
    ...
    private void initData() {
        ...
        faqsModel.add(new faqs_model(R.drawable.icon_right, "Khi đơn hàng của bạn được gửi đi, R3cy sẽ gửi cho bạn một email xác nhận vận chuyển cùng với mã theo dõi. Bạn có thể sử dụng mã này để theo dõi trạng thái vận chuyển của đơn hàng trên trang web hoặc trang web của dịch vụ vận chuyển.", "Làm thế nào để tôi theo dõi vận chuyển của đơn hàng?"));
        faqsModel.add(new faqs_model(R.drawable.icon_right, "Để thay đổi địa chỉ giao hàng, vui lòng liên hệ với chúng tôi càng sớm càng tốt.\n" +
        ...
        faqsModel.add(new faqs_model(R.drawable.icon_right, "R3cy có giao hàng đến các tỉnh thành khác ngoài TP.HCM, bao gồm các tỉnh miền Nam, miền Trung, miền Bắc.", "R3cy có giao hàng đến các tỉnh thành khác ngoài TP.HCM không?"));
        faqsModel.add(new faqs_model(R.drawable.icon_right, "Khu vực TP.HCM: thời gian giao nhận hàng từ 1 – 3 ngày làm việc\n" +
        ...
        faqsModel.add(new faqs_model(R.drawable.icon_right,"Thời gian dự kiến nhận hàng sẽ được hiển thị trong quá trình đặt hàng. Nếu có bất kỳ thay đổi nào, R3cy sẽ thông báo cho bạn qua email hoặc điện thoại.","Làm thế nào để tôi biết thời gian dự kiến nhận hàng sau khi đặt đơn hàng?"));
    }
