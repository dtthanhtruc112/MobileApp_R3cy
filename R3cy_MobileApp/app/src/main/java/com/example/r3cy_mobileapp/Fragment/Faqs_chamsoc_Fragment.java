...
public class Faqs_chamsoc_Fragment extends Fragment {
    ...
    private void initData() {
        ...
        faqsModel.add(new faqs_model(R.drawable.icon_right, "R3cy nhận sửa chữa có tính phí đối với các sản phẩm bị hư hỏng quá thời hạn bảo hành. Chi phí sửa chữa sẽ tùy thuộc vào tình trạng lỗi của sản phẩm.\n" +
        ...
        faqsModel.add(new faqs_model(R.drawable.icon_right, "Quy trình nhận và trả sản phẩm bảo hành được thực hiện như sau:\n" +
        ...
        faqsModel.add(new faqs_model(R.drawable.icon_right, "Tất cả sản phẩm của R3cy đều được bảo hành trong vòng 1 năm kể từ ngày mua. Trong thời gian bảo hành, nếu sản phẩm bị lỗi do nhà sản xuất, bạn có thể mang sản phẩm đến cửa hàng của chúng tôi để được đổi trả hoặc sửa chữa miễn phí.\n" +
