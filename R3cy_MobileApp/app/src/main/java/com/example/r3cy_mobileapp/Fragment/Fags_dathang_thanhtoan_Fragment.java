...
public class Fags_dathang_thanhtoan_Fragment extends Fragment {
    ...
    private void initData() {
        ...
        faqsModel.add(new Faqs(R.drawable.icon_right, "Trong trường hợp bạn cần thay đổi đơn hàng sau khi đặt, vui lòng liên hệ trực tiếp với R3cy:\n" +
                " • Điện thoại: 0123-456-789\n" +
                " • Email: info..r3cy.com", "Phải làm gì nếu tôi muốn thay đổi đơn hàng?"));
        faqsModel.add(new Faqs(R.drawable.icon_right, "Để đặt hàng online trên website của R3cy, bạn vui lòng thực hiện theo các bước sau:\n" +
                "\n" +
        ...
        faqsModel.add(new Faqs(R.drawable.icon_right,"Nếu sản phẩm bạn muốn đặt đã hết hàng, bạn có thể thực hiện theo các bước sau:\n" +
                "\n" +
        ...
        faqsModel.add(new Faqs(R.drawable.icon_right,"Các hình thức thanh toán của R3cy (bao gồm chuyển khoản và tiền mặt) không yêu cầu bạn cung cấp các thông tin thanh toán cá nhân có tính bảo mật.",
                "Thông tin thanh toán cá nhân của tôi có an toàn không?"));
        faqsModel.add(new Faqs(R.drawable.icon_right,"R3cy hiện đang hỗ trợ các hình thức thanh toán sau:\n" +
                "\n" +
