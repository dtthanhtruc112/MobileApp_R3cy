...
public class Faqs_sanpham_Fragment extends Fragment {
    ...
    private void initData() {
        ...
        faqsModel.add(new Faqs(R.drawable.icon_right, "R3cy cung cấp thông tin chi tiết về nguồn gốc của từng sản phẩm tái chế trên trang web. Bạn có thể xem thông tin này trong mô tả sản phẩm hoặc liên hệ trực tiếp với R3cy để biết thêm chi tiết.",
                "Làm thế nào để tôi biết nguồn gốc của sản phẩm tái chế ?"));
        faqsModel.add(new Faqs(R.drawable.icon_right,"Cách thức vệ sinh & bảo quản sản phẩm tái chế từ R3cy:\n" +
                "\n" +
        ...
        faqsModel.add(new Faqs(R.drawable.icon_right,"Sản phẩm tái chế được kiểm soát chất lượng và đảm bảo đạt chuẩn cao. Tuy nhiên, do nguyên liệu đã được sử dụng trước đó, có thể có những dấu vết nhỏ hoặc khác biệt nhỏ về màu sắc so với sản phẩm mới.",
        "Sản phẩm tái chế có chất lượng như sản phẩm mới không ?"));
        faqsModel.add(new Faqs(R.drawable.icon_right,"Số lượng được thiết kế & sản xuất của từng mẫu sản phẩm ở R3cy sẽ thay đổi tùy thuộc vào màu sắc, kích thước cho phép của những tấm bạt vụn, bạt cũ thu về.\n" +
        ...
        faqsModel.add(new Faqs(R.drawable.icon_right,"Sản phẩm tái chế là sản phẩm được chế tạo từ nguyên liệu tái chế, giúp giảm lượng rác thải và bảo vệ môi trường. Điều này giúp giữ lại giá trị của nguyên liệu và giảm tiêu thụ tài nguyên tự nhiên.",
