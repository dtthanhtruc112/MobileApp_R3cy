...
import com.example.r3cy_mobileapp.databinding.ActivityThugomBinding;
import com.google.android.material.bottomnavigation.BottomNavigationView;

public class Thugom extends AppCompatActivity {

    ActivityThugomBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityThugomBinding.inflate(getLayoutInflater());
        ...
        Log.d("SharedPreferences", "Email ở thugom: " + email);
