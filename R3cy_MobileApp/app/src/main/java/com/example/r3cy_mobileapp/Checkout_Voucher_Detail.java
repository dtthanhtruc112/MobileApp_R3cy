...
import com.example.r3cy_mobileapp.databinding.ActivityCheckoutVoucherDetailBinding;
...
public class Checkout_Voucher_Detail extends AppCompatActivity {

    ActivityCheckoutVoucherDetailBinding binding;
    Coupon coupon;
    VoucherCheckout voucher;
    R3cyDB db;
    Customer customer;
    String email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCheckoutVoucherDetailBinding.inflate(getLayoutInflater());
    ...
    private void getData() {
        ...
        if (bundle != null && bundle.containsKey("COUPON")) {
            voucher = (VoucherCheckout) bundle.getSerializable("COUPON");
            if (voucher != null) {
        ...
        if (customerId != -1) {
            ...
            while (c.moveToNext()) {
                try {
                    ...
                    boolean isValidVoucher = currentDate.after(validDate) && currentDate.before(expireDate);
