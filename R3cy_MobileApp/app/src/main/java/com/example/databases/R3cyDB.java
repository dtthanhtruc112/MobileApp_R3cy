...
public class R3cyDB extends SQLiteOpenHelper {
    ...
    public static final String TBl_PRODUCT_VER2 = "PRODUCT2";
...
//    Tạo constructor
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_TBL_PRODUCT_VER2);
...
//            PRODUCT_IMG2 + " BLOB DEFAULT NULL," +
//            PRODUCT_IMG3 + " BLOB DEFAULT NULL" +
            ")";

    // Câu lệnh tạo bảng PRODUCTVER2
    private static final String CREATE_TBL_PRODUCT_VER2 = "CREATE TABLE IF NOT EXISTS " + TBl_PRODUCT_VER2 + "(" +
            PRODUCT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
            PRODUCT_NAME + " TEXT NOT NULL," +
            PRODUCT_DESCRIPTION + " TEXT NOT NULL," +
            PRODUCT_THUMB + " BLOB," +
...
//    }
    ...
    public void createSampleProduct1() {
        if (numbOfRowsProduct() == 0){
